...
export const siteConfig = {
  name: "Felipe Costa Lisboa",
  role: {
    pt: "Engenheiro de Dados & Automação",
    en: "Data Engineer & Automation",
  },
  email: "lilfelipecosta@gmail.com",
  whatsapp: "5531998043035",
  linkedin: "https://www.linkedin.com/in/felipe-costa-lisboa/",
  github: "https://github.com/felipec-lisboa",
};
...
export const dictionary = {
  ...
  home: {
    ...
    focusItems: {
      pt: ["Engenharia de Dados", "IA & Automação", "Cloud & Infraestrutura", "Desenvolvimento de Software"],
      en: ["Data Engineering", "AI & Automation", "Cloud & Infrastructure", "Software Development"],
    },
